...
break;
case 5:MAX_HEAP = Number(yy_.yytext.substring(9).trim());
break;
case 6:MAX_HEAP_DISPLAY = Number(yy_.yytext.substring(17).trim());
break;
case 7:MAX_STACK_DISPLAY = Number(yy_.yytext.substring(18).trim());
break;
case 8:INSTRUCTION_MAX = Number(yy_.yytext.substring(16).trim());
break;
case 9:MAX_CACHE = Number(yy_.yytext.substring(10).trim());
break;
case 10:ACCURACY = Number(yy_.yytext.substring(9).trim());
break;
case 11:SHOW_ALL_DETAILS = false;
break;
case 12:FORCE_ENTRY_PROC=yy_.yytext.substring(17).trim();
break;
case 13:FORCE_ENTRY_POINT=yy_.yytext.substring(17).trim();
break;
case 14:/*ignore*/
break;
case 15:return 13;
